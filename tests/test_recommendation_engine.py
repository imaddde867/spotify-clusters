...
class TestCacheFunctions:
    ...
    def test_save_to_cache(self):
        ...
        with patch("recommendation_engine.load_song_cache", return_value={}), \
...
class TestRecommendationFunctions:
    ...
    def test_get_random_recommendations(self):
        ...
        assert all(col in recommendations.columns for col in ["track_name", "artist_name"])
...
class TestIntegration:
    ...
    def test_manual_testing_with_mocked_components(self, mock_load_components):
        ...
        mock_load_components.return_value = (
            mock_kmeans, mock_pca, mock_scaler_opt, mock_scaler_tempo,
            df_pca, df_clean, top_features
        )
